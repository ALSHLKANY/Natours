(() => {
  ...
  // utils/catchAsync.js
  var require_catchAsync = __commonJS({
    "utils/catchAsync.js"(exports, module) {
  ...
  var displayMap = (locations) => {
    mapboxgl.accessToken = "pk.eyJ1IjoiYWxzaGxrYW55IiwiYSI6ImNsdG11ZGYzdTF0dzIycXM0amdzOXF5Z2QifQ.sX4tTde_Zz6Meetg2JxJ7Q";
  ...
  var catchAsync = require_catchAsync();
  ...
  var userpwdForm = document.querySelector(".form-user-settings");
